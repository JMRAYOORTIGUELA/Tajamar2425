...
public class InicioSinrepeticion {
	public static Scanner sc=new Scanner(System.in);
	public static final int NumColoresCombinacion = 5;        	  /* Número de colores de una combinación */ 
	public static final int NumColoresJuego = 10;      
	public static final String[] TablaColores={"R", "A","V", "Z", "M","B","C","D","E","F"};
	...
	public static void Combinacion(String[] Com) {
     ...
     boolean colocado=true;
	     ...
	     for(int i=0;i<NumColoresCombinacion;i++) {
	    	do { 
		    	 color=TablaColores[alea(0,TablaColores.length-1)];
		    	 if (cadena.indexOf(color)>-1) {
		    		 colocado=false;
		    	 }else {
		    		 colocado=true;
		    		 cadena +=color;
